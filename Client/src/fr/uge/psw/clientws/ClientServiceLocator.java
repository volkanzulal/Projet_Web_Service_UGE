...
public class ClientServiceLocator extends org.apache.axis.client.Service implements fr.uge.psw.clientws.ClientService {
    ...
    private java.lang.String Client_address = "http://localhost:8080/ClientWS/services/Client";
    ...
    public fr.uge.psw.clientws.Client getClient(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.psw.clientws.ClientSoapBindingStub _stub = new fr.uge.psw.clientws.ClientSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.psw.clientws.Client.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.psw.clientws.ClientSoapBindingStub _stub = new fr.uge.psw.clientws.ClientSoapBindingStub(new java.net.URL(Client_address), this);
                _stub.setPortName(getClientWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://clientws.psw.uge.fr", "ClientService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://clientws.psw.uge.fr", "Client"));
        }
